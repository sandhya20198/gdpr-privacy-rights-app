...
// GDPR_VibeApp/node_modules/@facilio/vibe-sdk/dist/index.mjs
...
var Vibe = class {
  ...
  async executeAgent(name, input, opts = {}) {
    ...
    const body = { input };
    if ((_a = opts.fileIds) == null ? void 0 : _a.length) body.fileIds = opts.fileIds;
    const res = await this.fetch(url, {
      method: "POST",
      headers: { "Content-Type": "application/json", Accept: "application/json" },
      body: JSON.stringify(body)
  ...
  closeRealtime() {
    var _a;
    (_a = this.realtimeClient) == null ? void 0 : _a.close();
...
var VibeRealtime = class {
  ...
  send(frame) {
    var _a;
    if (((_a = this.socket) == null ? void 0 : _a.readyState) !== WebSocket.OPEN) return;
    try {
...
//# sourceMappingURL=@facilio_vibe-sdk.js.map
